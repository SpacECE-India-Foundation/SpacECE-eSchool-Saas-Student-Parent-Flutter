        ...
        child: SlideTransition(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Color(0xFFF8AF00), // Change color as needed
              borderRadius: const BorderRadius.only(
                bottomLeft: Radius.circular(15.0), // Rounded bottom-left corner
                bottomRight: Radius.circular(15.0), // Rounded bottom-right corner
              ),
            ),
            child: const Align(
